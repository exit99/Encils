...
var _class = function (_React$Component) {
  ...
  (0, _createClass3.default)(_class, [{
    ...
    value: function renderQuestion(question) {
      ...
      }, _react2.default.createElement('a', { className: 'right', style: { cursor: "pointer" }, onClick: function onClick() {
          return _this2.props.onDelete(question);
        }, 'data-tip': 'Delete', __source: {
          fileName: _jsxFileName,
          lineNumber: 11
        }
      }, _react2.default.createElement('div', { 'data-tip': 'Delete', className: 'btn-floating grey', __source: {
          fileName: _jsxFileName,
          lineNumber: 11
        }

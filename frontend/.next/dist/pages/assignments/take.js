  ...
  (0, _createClass3.default)(_class, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _rest.request)("GET", '/students/?classroom=' + classroomPk, null, function (data) {
        _this2.setState({ "students": data });
      });
      (0, _rest.request)("GET", "/auth/me/", null, function (data) {
        _this2.setState({ "sms": _nodePhoneFormatter2.default.format(data.sms, "(NNN) NNN-NNNN") });
      });
    }
  }, {
    ...
    key: 'startQuestion',
    value: function startQuestion(questionIndex) {
      var _this3 = this;
      ...
      _index2.default.push('/assignments/take?classroomPk=' + classroomPk + '&assignmentPk=' + assignmentPk + '&questionIndex=' + questionIndex);
      (0, _rest.request)("GET", '/questions/?assignment=' + assignmentPk, null, function (data) {
        _this3.setState({ "questions": data, "currentQuestion": data[questionIndex], answers: [] });
    ...
    value: function unAnsweredStudents() {
      ...
      return (0, _filter2.default)(students, function (s) {
        return answeredPks.indexOf(s.pk) === -1;
      });
    }
  }, {
